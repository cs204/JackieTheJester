...
step1 = 3 * sign.Rn (sign.StepSignal(), 3) #ваш код

#step2: сигнал равен -3.0 для t >= 7 и 0 для других t.
step2 = -3 * sign.Rn(sign.StepSignal(), 7) #ваш код


#stepUpDown: сигнал равен 3.0 для 3 <= t <= 6 и 0 для других t
stepUpDown = sign.Rn(sign.StepSignal() * 3, 3) + sign.Rn(sign.StepSignal() * (-3), 7) #ваш код
...
stepUpDownPoly = polyR(sign.UnitSampleSignal(), poly.Polynomial([5, 0, 3, 0, 1, 0]))  #ваш код
